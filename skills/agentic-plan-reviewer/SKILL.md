...
4. Record evidence-based findings and a `PASS`, `REPAIR_REQUIRED`, `BLOCKED`, or `PLAN_INVALID` outcome.
5. Return the structured handoff to the Primary Agent; do not repair the plan in place.
