    ...
    def test_approval_schema_and_wiki_routing_are_available(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            approval = self.write_json(
                ...
                {"approval_id": "APR-001", "target_type": "MASTER_PLAN", "target_id": "MP-001", "decision": "APPROVED", "approver": "primary-agent", "actor_type": "primary_agent", "actor_id": "primary-agent", "action": "MASTER_PLAN", "target_revision": 1, "target_hash": "0" * 64, "policy_version": "1", "issued_at": "2026-08-02T00:00:00Z", "expires_at": "2026-08-04T00:00:00Z", "evidence": "plan review passed", "created_at": "2026-08-02T00:00:00Z", "revision": 1},
            )
            ...
            wiki = (Path(__file__).resolve().parents[2] / "skills" / "agentic-engineering-core" / "references" / "wiki.md")
